...
async function sendOtpViaSms(phoneNumber, otp, context = 'verification') {
  if (!FAST2SMS_API_KEY) {
    ...
    console.error('❌ [FAST2SMS] Please set FAST2SMS_API_KEY environment variable');
    console.error('❌ [FAST2SMS] Get your API key from: https://www.fast2sms.com/dashboard/dev-api');
    throw new Error('SMS service not configured. Please contact support or use email OTP instead.');
  }
