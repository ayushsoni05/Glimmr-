...
export const StarIcon = ({ size = 24, className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={`text-amber-700 ${className}`}>
    <polygon points="12 2 15.09 10.26 24 10.26 17.55 16.16 19.64 24 12 18.09 4.36 24 6.45 16.16 0 10.26 8.91 10.26 12 2"/>
  </svg>
);

export const DiamondIcon = ({ size = 24, className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={`text-amber-700 ${className}`}>
    <path d="M12 2L2 7v3l1 7v5h16v-5l1-7V7l-10-5zm0 3l7 4h-14l7-4zm-8 7h16l-1 6h-14l-1-6z"/>
  </svg>
);
...
export const OrderIcon = ({ size = 24, className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={`text-amber-700 ${className}`}>
    <path d="M9 2L6 6H3v12c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V6h-3L15 2H9z"/>
...
export const GiftIcon = ({ size = 24, className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={`text-amber-700 ${className}`}>
    ...
    <polyline points="12 7 8 4 8 2 16 2 16 4 12 7"/>
  </svg>
);
...
export const RewardIcon = ({ size = 24, className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={`text-amber-700 ${className}`}>
    <polyline points="12 1 15 7 22 7 17 11 19 17 12 13 5 17 7 11 2 7 9 7"/>
  </svg>
);

export const CheckCircleIcon = ({ size = 24, className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={`text-emerald-700 ${className}`}>
...
export const AlertCircleIcon = ({ size = 24, className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={`text-rose-700 ${className}`}>
    <circle cx="12" cy="12" r="10"/>
